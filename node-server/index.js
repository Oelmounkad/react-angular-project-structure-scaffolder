...
const { createModuleFile, createComponentFiles, createServiceFiles } = require('./angular-structure-functions');
const { getServiceTsFileContentFromTemplate, getServiceSpecFileContentFromTemplate } = require('./angular-template-filler-functions');
